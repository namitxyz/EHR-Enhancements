    ...
    $("#apiCall").click(function(e){
        ...
        $.when(
            ...
            $.ajax({
                ...
                error :(function(){ alert ("Something went wrong.  We can not get provider's profile. ! ")}) 
            })
                ...
                <div class="remember-forgot">
                    <div class="row">
                        ...
                        <div class="col-md-6 forgot-pass-content">
                            ...
                            <a href="registerProvider.php" >Don't have a user-name and password yet? Register Now.</a>
                        </div>
                    </div>
                </div>
                </form>
